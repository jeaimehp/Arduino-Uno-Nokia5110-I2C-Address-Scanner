/* Nokia 5100 LCD Example Code
  ...
  Hardware: (Note most of these pins can be swapped)
   ...
   Ref for Nokia -- https://learn.sparkfun.com/tutorials/graphic-lcd-hookup-guide
...
void loop()
{
  ...
  // Ref I2C scanner -- http://henrysbench.capnfatz.com/henrys-bench/arduino-projects-tips-and-more/arduino-quick-tip-find-your-i2c-address/
  
  //updateDisplay();
  setStr("Searching I2C", 0, 0, BLACK);
  setStr("On SDA and SCL", 0, 10, BLACK);
  updateDisplay();
  ...
  for (byte i = 8; i < 120; i++)
  {
    ...
    if (Wire.endTransmission () == 0)
      ...
      if (count < 1){
      String devicehex = String (i, HEX);
      char dev1 [8];
      devicehex.toCharArray(dev1, 8);
      //Serial.print(devicehex);
      setStr("0x", 0,20, BLACK);
      setStr(dev1, 13, 20, BLACK);
      updateDisplay();
      }
      else {
      String devicehex = String (i, HEX);
      ...
      devicehex.toCharArray(dev1, 8);
      //Serial.print(devicehex);
      setStr("0x", 0,(20 * (count, DEC)), BLACK);
      setStr(dev1, 13, (20 * (count, DEC)), BLACK);
      updateDisplay();
      }
      
     // setStr(dev1[1], 7, 20, BLACK);
     // updateDisplay();
      Serial.println (")");
      count++;
